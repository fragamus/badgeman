...
get the app created:
    ...
    Creating myproject... done, stack is cedar
    http://myproject.herokuapp.com/ | git@heroku.com:myproject.git
...
It's live! Hit it with `curl`:
    ...
    $ curl http://myproject.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@myproject.herokuapp.com/repl
